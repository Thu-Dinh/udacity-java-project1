...
//		Assertions.assertTrue(driver.findElement(By.id("success-msg")).getText().contains("You successfully signed up!"));
	...
	public void testNote() {
		...
		noteTitles = driver.findElements(By.className("noteTitle"));
		Assertions.assertTrue(noteTitles.stream().map(e -> e.getText()).anyMatch(t -> t.equals("note title edit")));
		noteDescriptions = driver.findElements(By.className("noteDescription"));
		Assertions.assertTrue(noteDescriptions.stream().map(e -> e.getText()).anyMatch(t -> t.equals("note description edit")));
	...
	public void testCredential(){
		...
		editBtn.get(0).click();
		doAddCredential(".edit", "_edit", "12345");

		creUrls = driver.findElements(By.className("cre-url"));
		Assertions.assertTrue(creUrls.stream().map(e -> e.getText()).anyMatch(t -> t.equals("https://google.com.edit")));
		creUsernames = driver.findElements(By.className("cre-username"));
		Assertions.assertTrue(creUsernames.stream().map(e -> e.getText()).anyMatch(t -> t.equals("abcd_edit")));
